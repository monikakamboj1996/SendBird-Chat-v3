    ...
    <>
      ...
      <SafeAreaView style={style.container}>
        <View style={style.logoContainer}>
          <Image tintColor={Color.APP_COLOR} source={require('../asset/logo.png')} style={style.logo} />
        ...
        <View style={[style.loginForm]}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.85}
            style={[style.loginButton, { backgroundColor: state.connecting ? Color.APP_COLOR : Color.APP_COLOR }]}
            onPress={connect}
          >
